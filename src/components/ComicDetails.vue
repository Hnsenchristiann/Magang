<template>
    ...
    <link href="stylesheet" hreflang="http://www.w3schools.com/lib/w3.css" />
    <div class="container-book">
        <div class="container-info">
            ...
            <div class="container-text">
                ...
                <p class="title-tag">{{book.title}}</p>
    ...
    <div v-for="item in book" :key="item.id">
        <div class="container-details">
            ...
            <div class="card-tumpuk">
            </div>

            <div class="card2">
                <h1 class="judul">{{book.title}}</h1>
                <p class="comment">{{book.description}}e</p>
                <p class="jam">{{book.created_at}}</p>
                <div class="button">
...
<script>
    ...
    export default {
        ...
        mounted() {
            axios.get('http://127.0.0.1:8000/api/comic/8')
                .then(response => {
